        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<BackendConfiguration>;
                }
            } else
                return _observableThrow(response_) as any as Observable<BackendConfiguration>;
        }));
    }
...
export class ConversionClient {
    ...
    applyVideoConversionParams(fileId: number, param: VideoConversionParams): Observable<FileResponse> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processApplyVideoConversionParams(response_ as any);
                } catch (e) {
...
export class DeviceClient {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PresentationDevice[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PresentationDevice[]>;
        }));
    }
    ...
    getDeviceSensors(id: number): Observable<DeviceSensor[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetDeviceSensors(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<DeviceSensor[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<DeviceSensor[]>;
        }));
    }
...
export class ExhibitClient {
    ...
    sendPackage(exhibit_id: string | null, package_id: number): Observable<FileResponse> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSendPackage(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<FileResponse>;
                }
            } else
...
export class PackagesClient {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PresentationPackage[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PresentationPackage[]>;
        }));
    }
    ...
    getUnfinishedPackages(): Observable<PresentationPackage[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUnfinishedPackages(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PresentationPackage[]>;
                }
            } else
    ...
    getUnfinishedPackage(id: number): Observable<PresentationPackage> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUnfinishedPackage(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PresentationPackage>;
                }
            } else
    ...
    getUnfinishedPackageFiles(id: number): Observable<PackageFile[]> {
        let url_ = this.baseUrl + "/packages/unfinished/{id}/files";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUnfinishedPackageFiles(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUnfinishedPackageFiles(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PackageFile[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PackageFile[]>;
        }));
    }

    protected processGetUnfinishedPackageFiles(response: HttpResponseBase): Observable<PackageFile[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(PackageFile.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
    ...
    createNewPackage(type: PackageType): Observable<CreatedUnfinishedPackage> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateNewPackage(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<CreatedUnfinishedPackage>;
                }
            } else
                return _observableThrow(response_) as any as Observable<CreatedUnfinishedPackage>;
        }));
    }
    ...
    finishPackage(id: number): Observable<FinishedPackage> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFinishPackage(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<FinishedPackage>;
                }
            } else
                return _observableThrow(response_) as any as Observable<FinishedPackage>;
        }));
    }
    ...
    getMetadataForPackage(id: number): Observable<MetadataRecord[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetMetadataForPackage(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<MetadataRecord[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<MetadataRecord[]>;
        }));
    }
    ...
    saveMetadataForPackage(id: number, metadataRecords: MetadataRecord[]): Observable<FileResponse> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSaveMetadataForPackage(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<FileResponse>;
                }
            } else
    ...
    importMetadataFile(id: number, format: string | null, file: Blob): Observable<FileResponse> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processImportMetadataFile(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<FileResponse>;
                }
            } else
    ...
    setPackageProperties(id: number, properties: PackageProperties): Observable<FileResponse> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSetPackageProperties(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<FileResponse>;
                }
            } else
    ...
    setPackageParameters(id: number, parameters: Parameters): Observable<FileResponse> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSetPackageParameters(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<FileResponse>;
                }
            } else
    ...
    setPackageInputs(id: number, inputs: Action[]): Observable<FileResponse> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSetPackageInputs(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<FileResponse>;
                }
            } else
    ...
    getPackageHash(id: number): Observable<string> {
        let url_ = this.baseUrl + "/packages/hash/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetPackageHash(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPackageHash(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<string>;
                }
            } else
    ...
    protected processGetPackageHash(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class PackageFile implements IPackageFile {
    ...
    static fromJS(data: any): PackageFile {
        data = typeof data === 'object' ? data : {};
        let result = new PackageFile();
        result.init(data);
        return result;
    }
...
export class Mapping implements IMapping {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.transform = _data["transform"] ? Transform.fromJS(_data["transform"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["transform"] = this.transform ? this.transform.toJSON() : <any>undefined;
        return data;
    }
}
...
export class Transform implements ITransform {
    ...
    inMax?: InM | undefined;
    inMin?: InM | undefined;
    outMax?: OutM | undefined;
    outMin?: OutM | undefined;
    rangeMaxValue?: number | undefined;
    roundingMethod?: RoundingMethod | undefined;
    passValue?: string | undefined;

    constructor(data?: ITransform) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.comparisonValue = _data["comparisonValue"] ? ComparisonValue.fromJS(_data["comparisonValue"]) : <any>undefined;
            this.inMax = _data["inMax"] ? InM.fromJS(_data["inMax"]) : <any>undefined;
            this.inMin = _data["inMin"] ? InM.fromJS(_data["inMin"]) : <any>undefined;
            this.outMax = _data["outMax"] ? OutM.fromJS(_data["outMax"]) : <any>undefined;
            this.outMin = _data["outMin"] ? OutM.fromJS(_data["outMin"]) : <any>undefined;
            this.rangeMaxValue = _data["rangeMaxValue"];
            this.roundingMethod = _data["roundingMethod"];
            this.passValue = _data["passValue"];
        }
    }

    static fromJS(data: any): Transform {
        data = typeof data === 'object' ? data : {};
    ...
    toJSON(data?: any) {
        ...
        data["comparisonValue"] = this.comparisonValue ? this.comparisonValue.toJSON() : <any>undefined;
        data["inMax"] = this.inMax ? this.inMax.toJSON() : <any>undefined;
        data["inMin"] = this.inMin ? this.inMin.toJSON() : <any>undefined;
        data["outMax"] = this.outMax ? this.outMax.toJSON() : <any>undefined;
        data["outMin"] = this.outMin ? this.outMin.toJSON() : <any>undefined;
        data["rangeMaxValue"] = this.rangeMaxValue;
        data["roundingMethod"] = this.roundingMethod;
...
export class ComparisonValue implements IComparisonValue {
    bool?: boolean | undefined;
    double?: number | undefined;
    string?: string | undefined;

    constructor(data?: IComparisonValue) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.bool = _data["bool"];
            this.double = _data["double"];
            this.string = _data["string"];
        }
    }

    static fromJS(data: any): ComparisonValue {
        data = typeof data === 'object' ? data : {};
        let result = new ComparisonValue();
        result.init(data);
        return result;
    }
...
export class InM implements IInM {
    bool?: boolean | undefined;
    double?: number | undefined;

    constructor(data?: IInM) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
...
export interface IInM {
    bool?: boolean | undefined;
    double?: number | undefined;
}

export class OutM implements IOutM {
    double?: number | undefined;
    string?: string | undefined;

    constructor(data?: IOutM) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
